# Utilities and used Reverse Shell

Requirements :

- [NetCat Windows Install](https://www.configserverfirewall.com/windows-10/netcat-windows/)
- [Nmap all OSs](https://nmap.org/download.html)
